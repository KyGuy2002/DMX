...
{
    SPI1.beginTransaction(wiznet_SPI_settings);
    setSS();
    SPI1.transfer(_addr >> 8);
    SPI1.transfer(_addr & 0xFF);
    SPI1.transfer(_cb);
    SPI1.transfer(_data);
    resetSS();
    SPI1.endTransaction();
