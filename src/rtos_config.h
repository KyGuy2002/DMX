...
#define HTTP_TASK_PRIORITY          1    // Low - interactive
#define DMX_TASK_PRIORITY           1    // Low - interactive
#define MDNS_TASK_PRIORITY          0    // Lowest - background service

// ========== Task Timing (in milliseconds)
#define HTTP_TASK_DELAY_MS          10   // Delay between client checks
#define MDNS_TASK_DELAY_MS          50   // mDNS service interval
#define AUDIO_TASK_DELAY_MS         1    // Audio processing interval
#define DMX_TASK_DELAY_MS           100  // DMX processing interval (placeholder)
